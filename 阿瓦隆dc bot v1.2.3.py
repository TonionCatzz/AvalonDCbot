...
async def record(ctx):
    ...
    await ctx.send("範例 ：34o5-->3局，0湖4好，三藍刺殺5")
...
#        # ✅ 發到論壇頻道(先不要上線)
#        forum_channel = bot.get_channel(1132683080134578276)  #更改論壇ID
...
#    """根據論壇標題修改主題內容"""
#    forum_channel = bot.get_channel(1132683080134578276)  # 替換成你的論壇頻道 ID1132683080134578276
#
